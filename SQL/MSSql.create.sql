...
CREATE TABLE [Сцена] (
	 ...
	 [РаботникСцены_m0] UNIQUEIDENTIFIER  NULL,
...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [Сцена] ADD CONSTRAINT [Сцена_FРаботникСцены_0] FOREIGN KEY ([РаботникСцены_m0]) REFERENCES [РаботникСцены]
CREATE INDEX Сцена_IРаботникСцены_m0 on [Сцена] ([РаботникСцены_m0])
